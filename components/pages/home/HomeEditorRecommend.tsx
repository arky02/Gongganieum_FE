...
const HomeEditorRecommend = () => {
  return (
    <div className='flex h-full w-full items-center justify-center bg-gray-100 md:px-16 md:py-20'>
      <div className='flex max-w-412 flex-col gap-36 md:gap-16'>
        <div className='w-120 md:w-100'>
          <IconLogo />
        </div>
        <div className='flex flex-col gap-8 md:gap-4'>
          <h1 className='flex flex-col text-32 font-800 md:text-28'>
        ...
        <div className='relative mx-auto h-296 w-296 md:h-240 md:w-240'>
          <Image

...
const MagazineMainBanner = () => {
  return (
    <div className='relative  w-full bg-[#000]'>
      <div className="relative h-640 w-full bg-[url('/images/mock-son.webp')] bg-center bg-no-repeat md:h-540">
        <div className='flex h-full  w-full flex-col items-center justify-center gap-16 bg-[#000] opacity-60'></div>
        <div className='absolute bottom-1/3 left-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center  gap-8 md:bottom-60 md:w-full md:translate-y-0'>
          ...
          <h1 className='whitespace-nowrap text-[60px] font-800 text-white md:whitespace-pre-line md:text-wrap md:text-32'>
            송민혁과 보낸 <br className='hidden md:block' />
            가장 한국적인 휴가
          </h1>
        </div>
      </div>

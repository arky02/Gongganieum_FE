  ...
  return (
    <div className='flex w-full flex-col'>
      ...
      <div className='relative bg-[#000]'>
        ...
        {/* 사진 영역 */}
        <div className="relative flex min-h-800 flex-col  items-center justify-center bg-[url('/images/민지.jpg')] bg-cover bg-center bg-no-repeat text-white md:min-h-[80dvh]">
      ...
      <div className='my-28 flex min-h-1000 w-full flex-col items-center gap-40 md:px-20'>
        ...
        <div className='flex min-h-200 w-900 flex-col gap-20 text-16 leading-10 text-[#525559] md:w-full'>
          <img src={'/images/민지2.jpg'} alt='매거진 상세페이지 사진' />
          <p>
          ...
          <img src={'/images/민지3.webp'} alt='매거진 상세페이지 사진' />
          <p>
          ...
          <img src={'/images/민지4.webp'} alt='매거진 상세페이지 사진' />
          <p>
          ...
          <img src={'/images/민지5.webp'} alt='매거진 상세페이지 사진' />
        </div>
        {/* 건물 정보 */}
